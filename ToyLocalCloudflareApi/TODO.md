...
- [ ] Add GRDB/SQLite and create the app DB under Toy Local Application Support.
...
- [ ] Add an app-owned Keychain store for Toy Local cloud credentials, license/session metadata, and optional BYOK provider keys.

...
app.openapi(healthRoute, (c) =>
  c.json({ ok: true, service: "toy-local-cloudflare-api" }, 200)
);
app.get(
  "/docs",
  apiReference({
...
app.doc("/openapi.json", {
  info: {
    description:
      "Toy Local Cloudflare Worker API for cloud upload, transcription jobs, realtime ASR, text transforms, licensing, and usage.",
    title: "Toy Local Cloudflare API",
    version: "0.1.0",
  },
  openapi: "3.1.0",
});

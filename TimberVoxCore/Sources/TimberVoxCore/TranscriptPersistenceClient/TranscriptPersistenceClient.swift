...
public struct TranscriptPersistenceClient: Sendable {
  public var save:
    @Sendable (
      ...
      _ contextSnapshot: DictationContextSnapshot?
  ...
  public static let live: TranscriptPersistenceClient = {
    return TranscriptPersistenceClient(
      save: { result, audioURL, duration, sourceAppBundleID, sourceAppName, contextSnapshot in
        ...
        let ourAppFolder = supportDir.appendingPathComponent("com.chiejimofor.timbervox", isDirectory: true)

...
/// Central repository for timing thresholds and magic numbers used throughout TimberVoxCore.
///
...
public enum TimberVoxCoreConstants {
  ...
  ///
  /// **Used in:**
  /// - `TimberVoxSettings`: Default value for user preference
  ...
  ///
  /// **Used in:**
  /// - `TimberVoxSettings`: Default sound effects volume

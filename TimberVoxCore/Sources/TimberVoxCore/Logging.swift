...
/// Shared helper for creating consistent os.Logger instances across the TimberVox app and TimberVoxCore.
public enum TimberVoxLog {
  public static let subsystem = "com.chiejimofor.timbervox"
  ...
  public static let streaming = logger(.streaming)
}

...
public struct RecordingDecisionEngine {
  ...
  /// See `TimberVoxCoreConstants.modifierOnlyMinimumDuration` for rationale.
  public static let modifierOnlyMinimumDuration: TimeInterval = TimberVoxCoreConstants.modifierOnlyMinimumDuration

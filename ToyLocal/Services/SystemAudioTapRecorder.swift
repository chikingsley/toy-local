...
private let systemAudioLogger = ToyLocalLog.recording

final class SystemAudioTapRecorder: @unchecked Sendable {
  private let queue = DispatchQueue(label: "com.chiejimofor.toylocal.system-audio-tap", qos: .userInitiated)
  ...
  private func prepareTap() throws {
    ...
    tapDescription.name = "ToyLocal System Audio"
    ...
    let aggregateDescription: [String: Any] = [
      kAudioAggregateDeviceNameKey: "ToyLocal System Audio",

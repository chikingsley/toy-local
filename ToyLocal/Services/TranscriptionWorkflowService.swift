...
final class TranscriptionWorkflowService {
  ...
  private let cloud: ToyLocalCloudClient
  ...
  private func waitForCloudJob(jobID: String) async throws -> ToyLocalCloudJobStatus {
...
private extension ToyLocalCloudTranscriptSegment {

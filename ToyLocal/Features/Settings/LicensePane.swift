...
private enum LicensePaneCopy {
  static let productName = "ToyLocal"
  static let proBadge = "PRO"
  static let proHint = "ToyLocal Pro unlocks cloud models, mode sync, and priority updates while keeping local dictation available."
  ...
  static let xLabel = "X"
  static let promoTitle = "Enjoying ToyLocal?"

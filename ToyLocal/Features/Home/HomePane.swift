...
struct HomePane: View {
  ...
  private var microphoneSelection: Binding<String> {
    Binding(
      get: { settingsStore.toyLocalSettings.selectedMicrophoneID ?? Self.systemDefaultMicrophoneID },
      set: { selectedID in
        settingsStore.toyLocalSettings.selectedMicrophoneID =
  ...
  private var microphoneOptions: [TLMenuOption<String>] {
    ...
    if let selectedID = settingsStore.toyLocalSettings.selectedMicrophoneID,

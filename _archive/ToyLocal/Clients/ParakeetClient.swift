...
actor ParakeetClient {
  ...
  private let vendorDirs = [
    // Our app-specific cache path convention (under XDG or com.kitlangton.toylocal/cache)
    "fluidaudio/Models",
    "FluidAudio/Models",
  ...
  private func candidateRoots() -> [URL] {
    ...
    let appCache = appSupport?.appendingPathComponent("com.kitlangton.toylocal/cache", isDirectory: true)

...
extension URL {
	/// Returns the Application Support directory for ToyLocal
	static var hexApplicationSupport: URL {
		get throws {
			...
			let hexDir = appSupport.appending(component: "com.kitlangton.toylocal")
...
extension SharedReaderKey
	where Self == FileStorageKey<ToyLocalSettings>.Default
{

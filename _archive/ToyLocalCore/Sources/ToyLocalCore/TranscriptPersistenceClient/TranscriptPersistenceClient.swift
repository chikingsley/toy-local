    ...
    public static let liveValue: TranscriptPersistenceClient = {
        return TranscriptPersistenceClient(
            save: { result, audioURL, duration, sourceAppBundleID, sourceAppName in
                ...
                // We need the base URL. Since we can't easily access AppToyLocalSettings.hexApplicationSupport from here without circular dependency,
                ...
                let ourAppFolder = supportDir.appendingPathComponent("com.kitlangton.toylocal", isDirectory: true)

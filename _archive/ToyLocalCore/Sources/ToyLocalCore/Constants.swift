...
/// Central repository for timing thresholds and magic numbers used throughout ToyLocalCore.
///
...
public enum ToyLocalCoreConstants {
    ...
    ///
    /// **Used in:**
    /// - `ToyLocalSettings`: Default value for user preference
    ...
    ///
    /// **Used in:**
    /// - `ToyLocalSettings`: Default sound effects volume

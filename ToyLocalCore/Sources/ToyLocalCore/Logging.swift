...
/// Shared helper for creating consistent os.Logger instances across the ToyLocal app and ToyLocalCore.
public enum ToyLocalLog {
  public static let subsystem = "com.chiejimofor.toylocal"

...
public struct RecordingDecisionEngine {
  ...
  /// See `ToyLocalCoreConstants.modifierOnlyMinimumDuration` for rationale.
  public static let modifierOnlyMinimumDuration: TimeInterval = ToyLocalCoreConstants.modifierOnlyMinimumDuration

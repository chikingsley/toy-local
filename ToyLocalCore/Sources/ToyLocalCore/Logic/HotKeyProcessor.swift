...
private let hotKeyLogger = ToyLocalLog.hotKey
...
public struct HotKeyProcessor {
  ...
  public static let doubleTapThreshold: TimeInterval = ToyLocalCoreConstants.doubleTapWindow
  ...
  public static let pressAndHoldCancelThreshold: TimeInterval = ToyLocalCoreConstants.pressAndHoldCancelWindow
  ...
  public init(hotkey: HotKey, useDoubleTapOnly: Bool = false, minimumKeyTime: TimeInterval = ToyLocalCoreConstants.defaultMinimumKeyTime) {
    self.hotkey = hotkey
